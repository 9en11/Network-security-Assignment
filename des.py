# -*- coding: utf-8 -*-
"""
Created on Mon Feb  7 22:04:50 2022
    ...
    def run(self, key, text, action=ENCRYPT, padding=False):
        ...
        for block in text_blocks:#Loop over all the blocks of data
            ...
            for i in range(16): #Do the 16 rounds
                ...
                g = d
                d = tmp
                intermediate_res.append(g + d)
            result += self.permut(d+g, PI_1) #Do the last permut and append the result to result
        final_res = bit_array_to_string(result)
        if padding and action==DECRYPT:
            return self.removePadding(final_res) #Remove the padding if decrypt and padding is true
        else:
            return {"ciphers" : final_res, "intermediate_res" : intermediate_res} #Return the final string of data ciphered/deciphered
